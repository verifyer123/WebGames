...
var zucaritas = function(){
	...
	assets = {
        atlases: [
            {   
                name: "atlas.zucaritas",
                json: "images/zucaritas/atlas.json",
                image: "images/zucaritas/atlas.png",
            },
        ],
        images: [
    ...
    function setBalloons(){
        ...
        player.active = false
        moveUp = true
        buddy.setAnimationByName(0, "JUMP_DRON", true)
    ...
    function createPointsBar(){
        ...
        var pointsImg = pointsBar.create(10,10,'atlas.zucaritas','xpcoins')
    ...
    function createHearts(){
        ...
        var heartsImg = group.create(0,0,'atlas.zucaritas','life_box')
    ...
    function createParticles(tag,number){
        ...
        for(var i = 0; i < number;i++){
            ...
            if(tag == 'text'){
				...
				particle.makeParticles('atlas.zucaritas',tag);
    ...
    function addObjects(){
		...
		if(pivotObjects < -backHeight * 0.75){
			indexAdd = 2
		}
		
		if(pivotObjects < -backHeight * 1.77){
			indexAdd = 0
		}
	...
	function createOverlay(){
		...
		var tuto = overlayGroup.create(game.world.centerX, game.world.centerY - 50,'atlas.zucaritas','gametuto')
		...
		var inputLogo = overlayGroup.create(game.world.centerX ,game.world.centerY + 125,'atlas.zucaritas',inputName)
        inputLogo.anchor.setTo(0.5,0.5)
		inputLogo.scale.setTo(0.7,0.7)
		
		var button = overlayGroup.create(game.world.centerX, inputLogo.y + inputLogo.height * 1.5,'atlas.zucaritas','button')
	...
	return {
		...
		create: function(event){
            ...
            player = worldGroup.create(characterGroup.x, characterGroup.y,'atlas.zucaritas','dinamita')
            player.active = true
			...
			var container = levelContainer.create(0,0,'atlas.zucaritas','container')

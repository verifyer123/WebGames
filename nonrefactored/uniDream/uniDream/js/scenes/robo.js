...
var robo = function(){
	...
	function createRoboUI() {
		...
		for(var indexSpine = 0; indexSpine < 25; indexSpine++){
			var skinIndex = (indexSpine + 1) % ROBOTS.length
			var skin = ROBOTS[skinIndex]
			var dog1 = createSpine("dogs",skin)
			dog1.x = game.world.centerX
			dog1.y = game.world.centerY
			sceneGroup.add(dog1)
			dog1.setAnimation(["WIN"])
		}

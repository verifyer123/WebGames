...
var hover = function(){
	...
	assets = {
        atlases: [
            {   
                name: "atlas.hover",
                json: "images/hover/atlas.json",
                image: "images/hover/atlas.png",
            },
        ],
        images: [
			{   name:"background",
				file: "images/hover/background.png"},
			{   name:"background2",
				file: "images/hover/background2.png"},
		],
		sounds: [
            {	name: "magic",
    ...
    function createPointsBar(){
        ...
        var pointsImg = pointsBar.create(-10,10,'atlas.hover','xpcoins')
    ...
    function createHearts(){
        ...
        var heartImg = group.create(0,0,'atlas.hover','life_box')
	...
	function createOverlay(){
        ...
        if(!game.device.desktop){
			...
			var spaceBar = overlayGroup.create(game.world.centerX - 100,game.world.centerY + 125,'atlas.hover','spacebar')
			spaceBar.anchor.setTo(0.5,0.5)
			spaceBar.scale.setTo(0.7,0.7)
        }
		
		var inputLogo = overlayGroup.create(game.world.centerX + 35 + offsetX ,game.world.centerY + 125,'atlas.hover','pc')
        inputLogo.anchor.setTo(0.5,0.5)
		
		var button = overlayGroup.create(game.world.centerX, inputLogo.y + inputLogo.height,'atlas.hover','button')
	...
	function createGlobe(){
		...
		var globeImg = globeGroup.create(0,0,'atlas.hover','globe')
	...
	function createClock(){
        ...
        var clockImage = clock.create(0,0,'atlas.hover','clock')
        clockImage.anchor.setTo(0.5,0.5)
        
        var clockBar = clock.create(-clockImage.width* 0.38,19,'atlas.hover','bar')
	...
	function createBars(){
		...
		var blueBar = sceneGroup.create(game.world.centerX,100,'atlas.hover','plusbar')
		...
		var redBar = sceneGroup.create(game.world.centerX,game.world.height - 100,'atlas.hover','minusbar')
	...
	function createObjs(tag,scale,times){
        ...
        for(var i = 0;i<times;i++){
            ...
            if(tag == 'verde' || tag == 'rojo' || tag == 'coin' || tag == 'nave'){
                ...
                object = groundGroup.create(-300,game.world.height - 350,'atlas.hover',tag)
            }

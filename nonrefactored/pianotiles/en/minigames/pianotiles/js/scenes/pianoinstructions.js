var pianoInstructions = function(){
	...
	var localizationData = {
		"EN":{
			...
			"assetInstructions":"instructionen"
		},

		"ES":{
			"go":"OK",
			"howtoplay":"¿Cómo Jugar?",
			"instruction":"Toca la opción correcta",
			"assetInstructions":"instructiones"
		}
	}
	...
	function createInstructions(){
		...
		if(isMobileBrowser()){
			...
			var imageInstructions = circleGroup.create(0, 0, "atlas.instructionsScreen", "instruction")
			imageInstructions.anchor.setTo(0.5, 0.5)

			var fontStyle = {font: "150px VAGRounded", fill: "#ffffff", align: "center"}
	        
			fontStyle.font = "80px VAGRounded"
			var topText = new Phaser.Text(sceneGroup.game, 0, 0, localization.getString(localizationData, "howtoplay"), fontStyle)
			topText.y = game.world.height * -0.3
			topText.anchor.setTo(0.5, 0.5)
			circleGroup.add(topText)

			fontStyle.font = "45px VAGRounded"

			var bottomText = new Phaser.Text(sceneGroup.game, 0, 0, localization.getString(localizationData, "instruction"), fontStyle)
			bottomText.y = game.world.height * -0.15
	...
	function createScene(){
		...
		circleInstructions.centerX = game.world.centerX
		circleInstructions.centerY = game.world.centerY 

var soundsPath = "shared/sounds/"
var iconsPath = "shared/images/icons/"
...
var result = function(){
	...
	function setScore(didWin,score,index) {
        ...
        gameIndex = index
        //getNumbers()
        gameName = "ordersUp"//icons[gameIndex].mixName
    ...
    function createButtons(pivot){
        ...
        var buttonNames = ['reintentar']

        var buttonTexts = ['Reintentar']

...
import {swampShape} from "./scenes/swampShape";
import {preloaderIntro} from "../../scenes/preloader/preloader";

export function startGame(element){
	window.game = new Phaser.Game(element.innerWidth, element.innerHeight, Phaser.AUTO, element, {init: init, create: create }, false, true);

...
var instructions = function(){
	...
	var assets = {
        ...
        images: [
            ...
            {   name:"instruccion",
                file: "images/instructions/instruccion.png"},
		],
        sounds: [
            {	name: "click",
	...
	function startGame(obj){
        ...
        amazing.setMixPanelTrack("cirquitNetshoes","enterGame")
	...
	function initialize(){
        ...
        /*mixpanel.track(
            "loadGame",
            {"gameName": "cirquit","email":amazing.getEmail(),"gender":amazing.getGender(),"birthday":amazing.getBirthday()}
        );*/

        amazing.setMixPanelTrack("cirquitNetshoes","loadGame")

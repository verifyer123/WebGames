...
var instructions = function(){
	...
	function startGame(obj){
        ...
        /*mixpanel.track(
            "enterGame",
            {"gameName": "netshoes","email":amazing.getEmail(),"gender":amazing.getGender(),"birthday":amazing.getBirthday()}
        );*/

        amazing.setMixPanelTrack("netshoes","enterGame")
	...
	function initialize(){
        ...
        amazing.setMixPanelTrack("netshoes","loadGame")

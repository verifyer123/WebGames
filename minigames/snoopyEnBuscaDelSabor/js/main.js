...
function startGame(){
    ...
    function preload(){
        ...
        game.load.image("signo","../../shared/minigames/images/splash/!.png")
        game.load.image("a","../../shared/minigames/images/splash/a.png")
        game.load.image("by_g","../../shared/minigames/images/splash/by_g.png")
        game.load.image("g","../../shared/minigames/images/splash/g.png")
        game.load.image("i","../../shared/minigames/images/splash/i.png")
        game.load.image("m","../../shared/minigames/images/splash/m.png")
        game.load.image("n","../../shared/minigames/images/splash/n.png")
        game.load.image("z","../../shared/minigames/images/splash/z.png")

...
var chedraui = function(){    
    ...
    var objectNames = ['carne1','carne2','carne3','carne4','fruta1','fruta2','fruta3','plastico1','plastico2','plastico3','plastico4','enlatado1','enlatado2','verdura1','verdura2','verdura3','verdura4']
	...
	function initialize(){
        ...
        consecBricks = 0
        lastTag = null
        brickTexture = game.rnd.integerInRange(0,1)
        repeated = false
    ...
    function preload() {
        ...
        //game.load.spritesheet('coinS', 'images/chedraui/coinS.png', 68, 70, 12);
    ...
    function createControls(){
        ...
        var bottomRect = sceneGroup.create(game.world.centerX,game.world.height,'atlas.game','dashboard')
        ...
        var button1 = groupButton.create(0,0, 'atlas.game','arcadebutton2')
        button1.anchor.setTo(0.5,0.5)
        
        var button2 = groupButton.create(0,0, 'atlas.game','arcadebutton1')
    ...
    function addComplement(tag){
     ...
     function activateObject(posX, posY, child){
        ...
        if(child != null){
            ...
            if(child.tag == 'coin'){
                child.loadTexture('atlas.game',objectNames[game.rnd.integerInRange(0,objectNames.length-1)],0,false)
                child.body.y-=25
                if(Math.random()*2 > 1){
                    child.body.y-=80
                }
        ...
        for(var i = 0;i< groundGroup.length;i++){
            ...
            if(child.tag == tag && child.used == false){
                if (tag == "floor"){
                    ...
                    if(brickTexture==0){
                        child.loadTexture('atlas.game','brick',0,false)
                    }
                    else{
                        child.loadTexture('atlas.game','brick_1',0,false)
                    }
                    checkAdd(child,tag)
        ...
        for(var i = 0;i<times;i++){
            ...
            if(tag == 'enemy_spike'){
                ...
                /*if(randomize(10)){
                    ...
                    object = groundGroup.create(-300,200,'atlas.game',objectNames[indexCoin])
                ...
                object = groundGroup.create(-300,game.world.height - 350,'atlas.game',tag)
            }

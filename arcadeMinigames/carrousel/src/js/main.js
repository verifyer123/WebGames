...
for(var i = 0; i<= optimized.length-1;i++){
  $("#carrousel").append(
    `<div class="btnOptimized`+i+` container-gameSelect" data-order="`+optimized[i].mapUrl+`">
...
<div  class="bgGame`+i+` bg-selectgGame"></div>
        ...
        $(".btnOptimized" + i).click(function(){
           ...
           $("#bannerGame").html("<img src='https://yogome.github.io/WebGames/newStructure/minigames/" +optimized[place].mapUrl+ "/images/fbpost.png' />")
            ...
            //previewSong.play();
            $("#bannerGame").css("background-image","url(../images/bgbanner"+optimized[place].subject+".png)");
            updateRadar(

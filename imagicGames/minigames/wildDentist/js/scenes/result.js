...
var result = function(){
    ...
    function preload(){
        ...
        game.load.spritesheet('dinamita', 'images/result/dinamita.png', 175, 210, 23);
        //game.load.spritesheet('glow', imagesPath + 'result/dinamita.png', 175, 210, 24);
	...
	function createScene(){
        ...
        var dinamita = game.add.sprite(game.world.centerX - 180,topHeight * 0.5, "dinamita");
        var dinamitaPlay = dinamita.animations.add('dinamitaPlay');
		dinamita.animations.play('dinamitaPlay', 23, true);

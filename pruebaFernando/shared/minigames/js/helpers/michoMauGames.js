...
var michoMauGames={
    ...
    minigames : [
        ...
        {name:'MichoMau CortoCircuito',url:'cortoCircuito/',mapUrl:'cortoCircuito', sceneName:'cortoCircuito',subject:'math', review:true,objective:20,demo:false,type:gameTypeEnum.COUNT},
        {name:'MichoMau CuentaContactos',url:'cuentaContactos/',mapUrl:'cuentaContactos', sceneName:'cuentaContactos',subject:'geography', review:false,objective:15,demo:false,type:gameTypeEnum.TARGET},

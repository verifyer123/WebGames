...
var resultMichou = function(){
		...
		atlases: [
			{
				...
				json: imagesPath + "resultMichou/atlas.json",
				image: imagesPath + "resultMichou/atlas.png"},
		],
		images: [
	...
	function setScore(didWin,score,index,scale) {
        ...
        gamesList = michouResults.getGames()
...
//        );
    ...
    function preload(){
        ...
        game.load.spine('chispa', imagesPath + "resultMichou/spines/chispa.json");
		game.load.spine('yogotar', imagesPath + "resultMichou/spines/yogotar.json");
				
		game.load.image('shareText', imagesPath + 'resultMichou/shareES.png'); 
		game.load.image('retryText', imagesPath + 'resultMichou/retryES.png');

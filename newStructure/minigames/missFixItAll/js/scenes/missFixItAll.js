...
var missFixItAll = function(){
	...
	assets = {
        atlases: [
            {   
                name: "atlas.missFixItAll",
                json: "images/missFixItAll/atlas.json",
                image: "images/missFixItAll/atlas.png",
            },
            {   
                name: "atlas.time",
                json: "images/missFixItAll/timeAtlas.json",
                image: "images/missFixItAll/timeAtlas.png",
            },
            {   
                name: "atlas.tutorial",
        ...
        images: [
            {
				name:'tutorial_image',
				file:"images/missFixItAll/gametuto.png"
			}
    ...
    function createPointsBar(){
        ...
        var pointsImg = pointsBar.create(-10,10,'atlas.missFixItAll','xpcoins')
    ...
    function createHearts(){
        ...
        var heartImg = group.create(0,0,'atlas.missFixItAll','life_box')
    ...
    function createPart(key){
        ...
        particle.makeParticles('atlas.missFixItAll',key);
    ...
    function createParticles(tag,number){
        ...
        for(var i = 0; i < number;i++){
            ...
            if(tag == 'text'){
				...
				particle.makeParticles('atlas.missFixItAll',tag);
				particle.minParticleSpeed.setTo(-200, -50);
				particle.maxParticleSpeed.setTo(200, -100);
	...
	function setExplosion(obj){
        ...
        var exp = sceneGroup.create(0,0,'atlas.missFixItAll','cakeSplat')
        exp.x = posX
        exp.y = posY
        ...
        particlesGood.makeParticles('atlas.missFixItAll','smoke');
	...
	return {
		...
		create: function(event){
            ...
            /*fixSong = game.add.audio('fixSong')
            game.sound.setDecodedCallback(fixSong, function(){
                fixSong.loopFull(0.6)
            }, this);*/
            
            initialize()
            fixSong = sound.play("fixSong", {loop:true, volume:0.6})
			...
			buttons.getButton(fixSong,sceneGroup)
            createTutorial()

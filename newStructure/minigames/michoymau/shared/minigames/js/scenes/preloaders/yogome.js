var preloaderIntro = function(){
	...
	var assets = {
		atlases: [
			{
				name: "logoAtlas",
				json: "https://play.yogome.com/shared/minigames/images/preloaders/yogome/atlas.json",
				image: "https://play.yogome.com/shared/minigames/images/preloaders/yogome/atlas.png"}
		],
		images: [],
		sounds: [

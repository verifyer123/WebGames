var preloaderIntro = function(){
	...
	var assets = {
		atlases: [
			{
				name: "logoAtlas",
				json: "https://play.yogome.com/shared/minigames/images/preloaders/amazing/atlas.json",
				image: "https://play.yogome.com/shared/minigames/images/preloaders/amazing/atlas.png"}
		],
		images: [],
		sounds: [],
	}

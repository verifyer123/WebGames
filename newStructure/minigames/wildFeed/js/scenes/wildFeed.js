...
var wildFeed = function(){
    ...
    function feedThem(btn){
        ...
        if(gameActive){
            ...
            if(btn.food){
                btn.food.alpha = 1
                game.add.tween(btn.food).from({y: game.world.centerY - 200}, 1000, Phaser.Easing.linear, true).onComplete.add(function(){
                    btn.food.alpha = 0
                    win(ans, btn.food)
                })
            }
                ...
                game.add.tween(btn.parent.children[0].food).from({y: game.world.centerY - 200}, 1000, Phaser.Easing.linear, true)
                game.add.tween(btn.parent.children[2].food).from({y: game.world.centerY - 200}, 1000, Phaser.Easing.linear, true).onComplete.add(function(){

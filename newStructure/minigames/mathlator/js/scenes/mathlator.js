...
var mathlator = function(){
	...
	assets = {
        atlases: [
            {   
                name: "atlas.mathlator",
                json: "images/mathlator/atlas.json",
                image: "images/mathlator/atlas.png",
            },
            {   
                name: "atlas.time",
                json: "images/mathlator/timeAtlas.json",
                image: "images/mathlator/timeAtlas.png",
            },
            {   
                name: "atlas.tutorial",
        ...
        images: [
            {
				name:'tutorial_image',
				file:"images/mathlator/tutorial_image_%input.png"
			}
    ...
    function createPointsBar(){
        ...
        var pointsImg = pointsBar.create(-10,10,'atlas.mathlator','xpcoins')
    ...
    function createHearts(){
        ...
        var heartImg = group.create(0,0,'atlas.mathlator','life_box')
	...
	function createBackground(){
        ...
        var skeleton = game.add.spine(game.world.centerX, game.world.centerY, "skeleton")
        skeleton.setAnimationByName(0, "idle", true)
        skeleton.setSkinByName("normal")
        sceneGroup.add(skeleton)
    }
    ...
    function createPart(key){
        ...
        particle.makeParticles('atlas.mathlator',key);
    ...
    function createParticles(tag,number){
        ...
        for(var i = 0; i < number;i++){
            ...
            if(tag == 'text'){
				...
				particle.makeParticles('atlas.mathlator',tag);
				particle.minParticleSpeed.setTo(-200, -50);
				particle.maxParticleSpeed.setTo(200, -100);
	...
	function setExplosion(obj){
        ...
        var exp = sceneGroup.create(0,0,'atlas.mathlator','cakeSplat')
        exp.x = posX
        exp.y = posY
        ...
        particlesGood.makeParticles('atlas.mathlator','smoke');
    ...
    function initGame(){
        ...
        var word = numeroALetras(863)
        var cap = word.charAt(0)
        var rest =  word.substring(1)
        rest = rest.toLowerCase()
        var word = cap.concat(rest);
        console.log(word)
        
        var word = inWords(2302)
        console.log(word)
    }

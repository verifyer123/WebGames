...
var yogomeGames = function () {
	...
	function getGames(pathTag){
		...
		var games = [
            ...
            {name:'Soil Sweeper',url:urlSet + 'soilSweeper/',mapUrl:urlMap + 'soilSweeper', sceneName:'soilSweeper',subject:'sustainability', review:false,objective:5,demo:false, type:gameTypeEnum.CHOOSE},//159
		]

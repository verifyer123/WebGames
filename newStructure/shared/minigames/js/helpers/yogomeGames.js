var yogomeGames = function () {
	...
	var timeCount = 0
	var addingTime = true
	var yogoUrl = 'http://play.yogome.com/epicweb/minigames/epicSite/'
	...
	function getGames(pathTag){
		...
		var games = [
			...
			{name:'Milky Saloon',url:urlSet + 'milkySaloon/',mapUrl:urlMap + 'milkySaloon', sceneName:'milky',subject:'programming', review:false,objective:20,demo:false},//105
			{name:'Calendrigon',url:yogoUrl + 'calendrigon/',mapUrl:urlMap + 'calendrigon', sceneName:'calendrigon',subject:'math', review:false,objective:10},//106
			...
			{name:'Shot Put',url:yogoUrl + 'shotPut/',mapUrl:urlMap + 'shotPut', sceneName:'shotPut',subject:'sciencie', review:false,objective:10}//108
		]

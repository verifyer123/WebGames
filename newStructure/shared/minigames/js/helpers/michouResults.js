...
michouResults.getGames = function(){
	var games = [
        ...
        {name:'cuentaContactos',url:'http://yogome.com',sceneName:'cuentaContactos',subject:'math',review:true,advice:"Recuerda tener cuidado con los \n cables y enchufes eléctricos, y en caso\n de accidente siempre pedir ayuda\n a un adulto.",yogotar:"dinamita"},
        {name:'ollasLocas',url:'http://yogome.com',sceneName:'ollasLocas',subject:'math',review:true,advice:"Recuerda tener cuidado con los \n cables y enchufes eléctricos, y en caso\n de accidente siempre pedir ayuda\n a un adulto.",yogotar:"dinamita"}
	]
